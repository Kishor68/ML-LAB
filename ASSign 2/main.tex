...
Name & Pooranaa R S & Register No. & 3122235001097 \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{figures/class_distribution.png}
\caption{Class Distribution of Spam and Non-Spam Emails}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figures/feature_distribution.png}
\caption{Feature Distribution Plot (Sample Features)}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{figures/cm_GaussianNB.png}
\caption{Confusion Matrix for Gaussian Naïve Bayes}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{figures/cm_MultinomialNB.png}
\caption{Confusion Matrix for Multinomial Naïve Bayes}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{figures/cm_BernoulliNB.png}
\caption{Confusion Matrix for Bernoulli Naïve Bayes}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{figures/roc_GaussianNB.png}
\caption{ROC Curve for Gaussian Naïve Bayes}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{figures/roc_MultinomialNB.png}
\caption{ROC Curve for Multinomial Naïve Bayes}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{figures/roc_BernoulliNB.png}
\caption{ROC Curve for Bernoulli Naïve Bayes}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/accuracy_vs_k.png}
\caption{Accuracy vs. k Plot for KNN}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/train_vs_validation.png}
